...
#define GMAC_RXQCTRL0_RXQ0EN_DCB	0x2
...
#define MII_CLKSHIFT 8
#define MII_CLKRANGE_60_100M	(0)
#define MII_CLKRANGE_100_150M	(0x1 << MII_CLKSHIFT)
#define MII_CLKRANGE_20_35M	(0x2 << MII_CLKSHIFT)
#define MII_CLKRANGE_35_60M	(0x3 << MII_CLKSHIFT)
#define MII_CLKRANGE_150_250M	(0x4 << MII_CLKSHIFT)
#define MII_CLKRANGE_250_300M	(0x5 << MII_CLKSHIFT)
...
#define MTL_OP_MODE_RX_FEP		BIT(4)
#define MTL_OP_MODE_RX_FUP		BIT(3)
...
struct dwmac4_dev {
	...
	/* base address of entire gmac4 ip */
	void __iomem *ioaddr;
