...
static int sc58x_clock_probe(struct udevice *dev) {
	...
	clk_get_by_name(dev, "dummy", &clks[ADSP_SC58X_CLK_DUMMY]);
	clk_get_by_name(dev, "sys_clkin0", &clks[ADSP_SC58X_CLK_SYS_CLKIN0]);
	clk_get_by_name(dev, "sys_clkin1", &clks[ADSP_SC58X_CLK_SYS_CLKIN1]);
	...
	clks[ADSP_SC58X_CLK_CGU0_VCO_OUT] = sc5xx_cgu_pll("cgu0_vco", "cgu0_df",
		cgu0 + CGU_CTL, CGU_MSEL_SHIFT, CGU_MSEL_WIDTH, 0, false);
	clks[ADSP_SC58X_CLK_CGU1_VCO_OUT] = sc5xx_cgu_pll("cgu1_vco", "cgu1_df",
		cgu1 + CGU_CTL, CGU_MSEL_SHIFT, CGU_MSEL_WIDTH, 0, false);
	...
	// CDU output muxes
	clks[ADSP_SC58X_CLK_SHARC0_SEL] = cdu_mux("sharc0_sel", cdu + CDU_CFG0, sharc0_sels);
	clks[ADSP_SC58X_CLK_SHARC1_SEL] = cdu_mux("sharc1_sel", cdu + CDU_CFG1, sharc1_sels);
	clks[ADSP_SC58X_CLK_ARM_SEL] = cdu_mux("arm_sel", cdu + CDU_CFG2, arm_sels);
	clks[ADSP_SC58X_CLK_CDU_DDR_SEL] = cdu_mux("cdu_ddr_sel", cdu + CDU_CFG3, cdu_ddr_sels);
	...
	clks[ADSP_SC58X_CLK_RESERVED_SEL] = cdu_mux("reserved_sel", cdu + CDU_CFG6, reserved_sels);
	...
	clks[ADSP_SC58X_CLK_SHARC0] = cdu_gate("sharc0", "sharc0_sel", cdu + CDU_CFG0, CLK_IS_CRITICAL);
	clks[ADSP_SC58X_CLK_SHARC1] = cdu_gate("sharc1", "sharc1_sel", cdu + CDU_CFG1, CLK_IS_CRITICAL);
	clks[ADSP_SC58X_CLK_ARM] = cdu_gate("arm", "arm_sel", cdu + CDU_CFG2, CLK_IS_CRITICAL);
	clks[ADSP_SC58X_CLK_CDU_DDR] = cdu_gate("cdu_ddr", "cdu_ddr_sel", cdu + CDU_CFG3, CLK_IS_CRITICAL);
	...
	clks[ADSP_SC58X_CLK_RESERVED] = cdu_gate("reserved", "reserved_sel", cdu + CDU_CFG6, 0);
