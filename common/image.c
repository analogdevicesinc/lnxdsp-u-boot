	...
	*load_end = load;
	...
	case IH_COMP_NONE:
		...
		if (image_len <= unc_len)
			...
			ret = -ENOSPC;
		break;
#if defined(CONFIG_GZIP) || defined(CONFIG_SPL_GZIP)
...
#endif /* CONFIG_GZIP */
#if defined(CONFIG_BZIP2) || defined(CONFIG_SPL_BZIP2)
	case IH_COMP_BZIP2: {
		uint size = unc_len;
...
#endif /* CONFIG_BZIP2 */
#if defined(CONFIG_LZMA) || defined(CONFIG_SPL_LZMA)
	case IH_COMP_LZMA: {
...
#endif /* CONFIG_LZMA */
#if defined(CONFIG_LZO) || defined(CONFIG_SPL_LZO)
	case IH_COMP_LZO: {
		size_t size = unc_len;
...
#endif /* CONFIG_LZO */
#if defined(CONFIG_LZ4) || defined(CONFIG_SPL_LZ4)
	case IH_COMP_LZ4: {
		size_t size = unc_len;
...
#endif /* CONFIG_LZ4 */
#if defined(CONFIG_ZSTD) || defined(CONFIG_SPL_ZSTD)
	case IH_COMP_ZSTD: {
		size_t size = unc_len;
