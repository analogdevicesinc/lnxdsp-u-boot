...
#define P_UART1_TX      (P_DEFINED | P_IDENT(GPIO_PD2) | P_FUNCT(0))
#define P_UART1_RX      (P_DEFINED | P_IDENT(GPIO_PD2) | P_FUNCT(0))
#define P_UART1_RTS     (P_DEFINED | P_IDENT(GPIO_PD2) | P_FUNCT(0))
#define P_UART1_CTS     (P_DEFINED | P_IDENT(GPIO_PD2) | P_FUNCT(0))
...
#define P_MII0_MDC	(P_DEFINED | P_IDENT(GPIO_PH3) | P_FUNCT(0))
#define P_MII0_MDIO	(P_DEFINED | P_IDENT(GPIO_PH4) | P_FUNCT(0))
#define P_MII0_ERxD0	(P_DEFINED | P_IDENT(GPIO_PH5) | P_FUNCT(0))
#define P_MII0_ERxD1	(P_DEFINED | P_IDENT(GPIO_PH6) | P_FUNCT(0))
#define P_MII0_REFCLK	(P_DEFINED | P_IDENT(GPIO_PH7) | P_FUNCT(0))
#define P_MII0_CRS	(P_DEFINED | P_IDENT(GPIO_PH8) | P_FUNCT(0))
#define P_MII0_ERxD2	(P_DEFINED | P_IDENT(GPIO_PH11) | P_FUNCT(0))
#define P_MII0_ERxD3	(P_DEFINED | P_IDENT(GPIO_PH12) | P_FUNCT(0))
#define P_MII0_ETxEN	(P_DEFINED | P_IDENT(GPIO_PH13) | P_FUNCT(0))
#define P_MII0_ETxCLK	(P_DEFINED | P_IDENT(GPIO_PH14) | P_FUNCT(0))
#define P_MII0_ETxD2	(P_DEFINED | P_IDENT(GPIO_PH15) | P_FUNCT(0))
#define P_MII0_ETxD3	(P_DEFINED | P_IDENT(GPIO_PI0) | P_FUNCT(0))
...
#define P_MII1_CRS	(P_DEFINED | P_IDENT(GPIO_PF3) | P_FUNCT(0))
#define P_MII1_MDC	(P_DEFINED | P_IDENT(GPIO_PF2) | P_FUNCT(0))
#define P_MII1_MDIO	(P_DEFINED | P_IDENT(GPIO_PF1) | P_FUNCT(0))
#define P_MII1_REFCLK	(P_DEFINED | P_IDENT(GPIO_PE11) | P_FUNCT(0))
#define P_MII1_ETxEN	(P_DEFINED | P_IDENT(GPIO_PE12) | P_FUNCT(0))
#define P_MII1_ETxD0	(P_DEFINED | P_IDENT(GPIO_PE13) | P_FUNCT(0))
#define P_MII1_ETxD1	(P_DEFINED | P_IDENT(GPIO_PE14) | P_FUNCT(0))
#define P_MII1_ERxD0	(P_DEFINED | P_IDENT(GPIO_PE15) | P_FUNCT(0))
#define P_MII1_ERxD1	(P_DEFINED | P_IDENT(GPIO_PF0) | P_FUNCT(0))
...
#define P_I2C2_SDA (P_DEFINED | P_IDENT(GPIO_PA15) | P_FUNCT(0))
#define P_I2C2_SCL (P_DEFINED | P_IDENT(GPIO_PA14) | P_FUNCT(0))
