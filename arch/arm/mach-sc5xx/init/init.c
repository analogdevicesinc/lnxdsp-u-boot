...
static inline
void Program_Cgu(u32 uiCguNo, struct CGU_Settings *pCGU_Settings, bool useExtension0, bool useExtension1)
{
    u32 dNewCguDiv;
    u32 cgu_offset = 0x1000 * uiCguNo;
    u32 extension = 0;
 ...
 */
static inline
u32 CGU_Init(uint32_t uiCguNo, uint32_t uiClkinsel,
