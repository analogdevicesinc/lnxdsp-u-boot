...
typedef struct{
    u32 REG_DMC_PHY_CTL4;
    u32 REG_DMC_PHY_CTL3;
    u32 REG_DMC_PHY_CTL2;
    u32 REG_DMC_PHY_CTL1;
    u32 REG_DMC_PHY_CTL0;
    u32 REG_DMC_CPHY_CTL;
    u32 REG_DMC_CAL_PADCTL2;
    u32 REG_DMC_CAL_PADCTL0;
    u32 REG_DMC_CFG;
    u32 REG_DMC_TR0;
    u32 REG_DMC_TR1;
    u32 REG_DMC_TR2;
    ...
    u32 REG_DMC_CTL;
    u32 REG_DMC_STAT;
    u32 VAL_DMC_DATA_CALIB_ADD;
    u32 REG_DMC_DT_CALIB_ADDR;
#if defined(CONFIG_SC59X) || defined(CONFIG_SC59X_64)
    u32 REG_DMC_EMR3;
    u32 REG_DMC_DDR_CA_CTL;
    u32 REG_DMC_DDR_ROOT_CTL;
    u32 REG_DMC_DDR_LANE0_CTL0;
    u32 REG_DMC_DDR_LANE0_CTL1;
    u32 REG_DMC_DDR_LANE1_CTL0;
    u32 REG_DMC_DDR_LANE1_CTL1;
    u32 REG_DMC_DDR_SCRATCH_2;
    u32 REG_DMC_DDR_SCRATCH_3;
    u32 REG_DMC_DDR_ZQ_CTL0;
    u32 REG_DMC_DDR_ZQ_CTL1;
    u32 REG_DMC_DDR_ZQ_CTL2;
    u32 REG_DMC_DDR_SCRATCH_6;
    u32 REG_DMC_DDR_SCRATCH_7;
    u32 REG_DMC_DDR_SCRATCH_STAT0;
    u32 REG_DMC_DDR_SCRATCH_STAT1;
#endif
} DMC_REGISTERS;
...
#define DECLARE_DMC_REGISTERS(x) \
    static DMC_REGISTERS dmc_registers##x __section(".text") = { \
