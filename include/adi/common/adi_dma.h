...
#define BITM_DMA_DSCPTR_NXT_VALUE            (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFF,_Addr_t))    /* Pointer to Next Descriptor Set */

/* -------------------------------------------------------------------------------------------------------------------------
          DMA_ADDRSTART                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_DMA_ADDRSTART_VALUE              0            /*  Work Unit Address Start Value */
#define BITM_DMA_ADDRSTART_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFF,_Addr_t))    /* Work Unit Address Start Value */
...
#define BITM_DMA_DSCPTR_CUR_VALUE            (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFF,_Addr_t))    /* Pointer for Current Descriptor Element */
...
#define BITM_DMA_ADDR_CUR_VALUE              (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFF,_Addr_t))    /* Work Unit Current Address Value */
